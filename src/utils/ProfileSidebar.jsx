    ...
    <aside className="bg-white shadow rounded-xl p-6 h-fit">
      ...
      <div className="flex flex-col items-center">
        <img
          ...
          alt="profile"
        />
        <h3 className="mt-4 text-base  font-medium">Rohit Sharma</h3>
      </div>
      ...
      <nav className="mt-8 space-y-2">
        <a
          href="/profile/orders"
          className={`flex items-center text-sm font-normal gap-2 px-4 py-3 rounded-lg 
                ${
                  active === "orders"
        ...
        <div className="mt-4 border-t border-gray-200 pt-4">
          <button className="w-full flex items-center gap-2 px-4 py-3 text-base font-normal text-red-600 rounded-lg hover:bg-red-50">
