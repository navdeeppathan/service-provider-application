  ...
  return (
    <div>
      ...
      <div className="space-y-4">
          ...
          {booking.payment.method === "card" && (
            <div className="mt-4 grid grid-cols-1 gap-3">
              ...
              <input
                ...
                onChange={(e) =>
                  updateBooking("payment.cardNumber", e.target.value)
                }
              />
              <div className="grid grid-cols-2 gap-3">
                <input
                  ...
                  onChange={(e) =>
                    updateBooking("payment.expiry", e.target.value)
                  }
                />
                <input
                  type="text"
        ...
        <label
          className={`block border rounded-lg p-2 ${
            booking.payment.method === "upi" ? "ring-2 ring-purple-200" : ""
          }`}
        >
          <input
            type="radio"
          ...
          />{" "}
          <span className="ml-2 text-sm font-medium">UPI / Wallet</span>
        ...
        <label
          className={`block border rounded-lg p-2 ${
            booking.payment.method === "cod" ? "ring-2 ring-purple-200" : ""
          }`}
        >
          <input
            type="radio"
            name="payment"
            checked={booking.payment.method === "cod"}
