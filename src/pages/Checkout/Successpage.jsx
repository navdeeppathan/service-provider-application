...
import { CheckCircle, Calendar, Package, CreditCard, FileText } from "lucide-react";
      ...
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-emerald-50 to-blue-50 px-4 py-10">
        <div className="w-full max-w-md bg-white rounded-2xl shadow-xl border border-gray-100 p-6">
          ...
          <div className="mt-6 flex flex-col sm:flex-row gap-3">
            <Link 
              to="/profile/orders" 
              className="flex-1 bg-[#5E72C6] text-white text-center py-3 rounded-xl font-semibold hover:bg-emerald-700 transition"
            >
              View My Bookings
            </Link>
            ...
            <Link 
              to="/" 
              className="flex-1 bg-gray-100 text-gray-800 text-center py-3 rounded-xl font-semibold border hover:bg-gray-200 transition"
            >
