...
<button className="text-sm text-blue-600">Make Default</button>
...
<input className="border rounded p-2" placeholder="Expiry MM/YY" />
<input className="border rounded p-2" placeholder="CVV" />
</div>
<button className="mt-3 bg-[#3b82f6] text-white px-4 py-2 rounded">Add Card</button>
</div>
</div>
</div>
</ProfileLayout>
