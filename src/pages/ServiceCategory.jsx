    ...
    <>
      ...
      <section className="py-20 mx-auto max-w-6xl">
        <div className="text-center">
          ...
          <p className="text-gray-600  max-w-xl mx-auto mt-3 text-sm">
        ...
        <div className="container mx-auto mt-14">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {currentItems.map((service) => (
              ...
              >
                <div
                  className="
                    group bg-white border border-gray-200 rounded-2xl p-4 h-[250px]
                    shadow-sm hover:shadow-xl hover:border-blue-400
                    transition-all duration-300 relative overflow-hidden
                  "
                >
                  {/* Icon */}
                  <div className="w-12 h-12 bg-[#5E72C6] text-white rounded-2xl flex items-center justify-center text-3xl mb-5 mx-auto group-hover:scale-110 transition">
                    <i className={service.icon}></i>
                  </div>

                  {/* Title */}
                  <h3 className="text-lg text-center font-medium  text-gray-900 group-hover:text-[#5E72C6] transition">
                    {service.title}
                  </h3>

                  {/* Description */}
                  <p className="text-gray-500 mt-2 text-center text-sm leading-relaxed line-clamp-3">
                    {service.decs}
                  </p>
          ...
          <div className="flex justify-center mt-14 gap-2">
            <button
              ...
              className="px-3 py-1 border rounded-lg shadow-sm bg-white hover:bg-gray-100 disabled:opacity-50"
            >
              &lt;
            </button>
              ...
              num === "..." ? (
                ...
                <button
                  ...
                  className={`
                    ...
                    ${
                      currentPage === num
                        ? "bg-[#5E72C6] text-white border-[#5E72C6]"
